...
A selection of the most-used tools is shown below. For the full set of all 73 tools — including namespaces, sessions, plans & tasks, policy, taint, and reminders — see the [MCP Tools reference](/reference/mcp-tools/).
