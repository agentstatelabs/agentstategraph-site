...
- **7.1 Tools** -- All 73 tools with full parameter schemas, descriptions, and example inputs/outputs.
...
- **11.3 MCP Server** -- The `agentstategraph-mcp` crate with all 73 tools plus the `migrate` subcommand.
